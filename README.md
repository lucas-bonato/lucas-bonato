...
### 💻 Tech Stack  
<p align="center">
  <img src="https://skillicons.dev/icons?i=go,python,java,postgres,docker,react,javascript,typescript&theme=light&perline=5" />
</p>

---

### 🧠 About Me  
- 🚀 Focused on **Go**, **Python**, and fullstack development  
- 🧩 3+ years delivering scalable, end-to-end applications  
- 🔍 Motivated by understanding how things *really* work under the hood  
